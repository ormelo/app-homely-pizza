...
class Guide extends React.Component {
    ...
    render() {
            ...
            <div className="logo" id="logoWrapper">
                <img id="logo" className="logo-img" src="../img/images/logo_a.png" />
            ...
            <div><i className="loading"></i></div>
                ...
                <div className="main">
                    <div>
                        ...
                        <div className="header">Interior designers handpicked for you<br/><div className="sub-head">Authentic recommendations for your unique ideas</div></div>
                        <img className="curve" src="./img/images/curve.png"/>
                        <div className="scroll-arrow">
                            <span/><span/><span/>
                        </div>
                    </div>
                    <div className="overview">Answer quick questions to see your matches!</div>
