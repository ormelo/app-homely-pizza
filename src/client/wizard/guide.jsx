...
class Guide extends React.Component {
    ...
    render() {
            ...
            <div className="logo" id="logoWrapper">
                <img id="logo" className="logo-img" src="../img/images/logo.jpg" />
            ...
            <div><i className="loading"></i></div>
                ...
                <div className="main">
                    <div>
                        ...
                        <div className="header">Par-baked Gourmét<br/>Pizzas<br/></div>
                        <img className="curve" src="./img/images/curve.png"/>
                        <div className="scroll-arrow">
                            <span/><span/><span/>
                        </div>
                    </div>
                    <div className="overview">Deliciously hot 🔥 & fresh</div>
                    ...
                    <hr className="line"/>
                                            ...
                                            <div className="post-heading">
                                                <div className="info" style={{marginTop: '0px'}}>
                                                    <div className="para" style={{marginTop: '0px'}}>
                                                       ...
                                                       Homely Pizza was born out of the voice of Indian locals craving exotic food, to be dined at home - <b>fresh</b> & <b>hot</b> at affordable prices.
                                                       <br/><br/>
                                        ...
                                        <div className="section no-padding">
                                            <div className="post-heading">
                                                <div className="title">Rated 5⭐️ by customers</div>
                                                <div className="info" style={{marginTop: '34px'}}>
                                                    <div className="aslider">
                                                            <div className="aslide"><div class="fb-post" data-width="350" data-href="https://www.facebook.com/vinayakshenoyk/posts/3426876977372979" data-show-text="true" data-width=""><blockquote cite="https://www.facebook.com/vinayakshenoyk/posts/3426876977372979" class="fb-xfbml-parse-ignore"><p>After coming across Homely pizza on Instagram, decided to give it a try. Was not disappointed.
                                                                                                                     I ordered medium sized...</p>Posted by <a href="#" role="button">Vinayak Shenoy K</a> on&nbsp;<a href="https://www.facebook.com/vinayakshenoyk/posts/3426876977372979">Wednesday, 23 September 2020</a></blockquote></div></div>
                                                            <br/>
                                                            <div className="aslide"><div class="fb-post" data-href="https://www.facebook.com/rajesh.ign/posts/10207037166683988" data-show-text="true" data-width=""><blockquote cite="https://www.facebook.com/rajesh.ign/posts/10207037166683988" class="fb-xfbml-parse-ignore"><p>It is very yummy and delicious. It is the best pizza I ever ate.</p>Posted by <a href="#" role="button">Rajesh Kumar</a> on&nbsp;<a href="https://www.facebook.com/rajesh.ign/posts/10207037166683988">Saturday, 19 September 2020</a></blockquote></div></div>
                                                    ...
                                                    <div className="para" style={{marginTop: '14px'}}>
                                                       <div className="title">Why Homely Pizza?</div>
                                                    </div>
                                        ...
                                        <div className="section no-padding" style={{marginTop: '40px'}}>
                                             <div className="post-heading">
                                                <div className="info">
                                                    <img src="./img/images/pizza.png" className="ic-num"/>
                                                    <div className="desc caption">Par-baked pizzas</div>
                                                    <div className="desc" style={{marginTop: '20px'}}>Our custom baking technique ensures you enjoy a hot pizza by simply warming on a pan for 3 mins, without losing any flavor!</div>
                                                </div>
                                             </div>
                                         </div>
                                         <div className="section no-padding" style={{marginTop: '40px'}}>
                                              <div className="post-heading">
                                                 <div className="info">
                                                     <img src="./img/images/pineapple.png" className="ic-num"/>
                                                     <div className="desc caption">Premium yet affordable</div>
                                                     <div className="desc" style={{marginTop: '20px'}}>With zero preservatives, all the ingredients are freshly prepped just on receiving your order!</div>
                                                 </div>
                                              </div>
                                          </div>
                                          <div className="section no-padding" style={{marginTop: '40px'}}>
                                            <div className="post-heading">
                                               <div className="info">
                                                   <img src="./img/images/deliveryman.png" className="ic-num"/>
                                                   <div className="desc caption">Hygienic packaging</div>
                                                   <div className="desc" style={{marginTop: '20px'}}>COVID-safe packaging with disinfection on upper surface with contactless delivery to ensure the best of safety!</div>
                                               </div>
                                            </div>
                                        </div>
